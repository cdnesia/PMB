<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5" x-data="{}">
        ...
        <div>
            ...
            <div class="mt-2">
                <select name="sumber_informasi_id" id="sumber_informasi_id" required
                    ...
                    <option value="" disabled @selected(! old('sumber_informasi_id'))>{{ __('auth.sumber_informasi_placeholder') }}</option>
