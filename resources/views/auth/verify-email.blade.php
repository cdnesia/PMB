<x-guest-layout>
    <div class="text-center">
        ...
        <h1 class="mt-4 text-lg font-bold text-gray-900">{{ __('auth.verify_email_title') }}</h1>
    ...
    <div class="mt-6 space-y-4">
        <form method="POST" action="{{ route('verification.send') }}">
            @csrf
            <x-ui-button variant="primary" class="w-full">{{ __('auth.resend_verification') }}</x-ui-button>
        </form>
